...
def recommendations_for_risk(risk: RiskSummary | None, flight_ids: list[str]) -> list[RecommendationCard]:
    if risk is None:
        return [
            RecommendationCard(
                ...
                confidence_pct=76,
                affected_flight_ids=[],
                agent_contributors=["Jarvis", "Auditor"],
    ...
    cards = [
        RecommendationCard(
            ...
            agent_contributors=["Air Marshal", "Domino", "Auditor"],
        ...
        RecommendationCard(
            ...
            agent_contributors=["Weather Boy", "Air Marshal", "Historian", "Auditor"],
    ...
    if risk.altitude_band == "LOW":
        cards.append(
            RecommendationCard(
                ...
                agent_contributors=["Air Marshal", "Auditor"],
